...
var Config = /** @class */ (function () {
    ...
    Config.prototype.getPlainObject = function () {
        ...
        // Resolve `extends`
        for (var _i = 0, _c = Object.keys(copy.jobs); _i < _c.length; _i++) {
            var key = _c[_i];
            var job = copy.jobs[key];
            if (job.extends) {
                var result = {};
                for (var _d = 0, _e = job.extends; _d < _e.length; _d++) {
                    var from = _e[_d];
                    var jobObj = ((_a = this.plain.jobs) === null || _a === void 0 ? void 0 : _a[from]) || ((_b = this.plain.jobs) === null || _b === void 0 ? void 0 : _b["." + from]);
                    if (!jobObj) {
                        console.warn("The job \"" + from + "\" does not exist, skipping...");
                    }
                    result = deepmerge_1.default(result, jobObj);
                }
                copy.jobs[key] = deepmerge_1.default(result, job);
            }
        }
        // Move jobs to root
